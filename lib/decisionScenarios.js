...
export const DECISION_SCENARIOS = [
  {
    ...
    blurb: 'Password reset failed. Trip tomorrow. Not asking for a refund.',
    surface: 'ticket',
  ...
  },
  {
    ...
    blurb: 'They say cancel — maybe pause, maybe refund, maybe just mad.',
    surface: 'ticket',
    editHint: TICKET_HINT,
    state: {
      subject: 'Cancel unless streaming is fixed',
      message:
        'I want to cancel unless streaming is fixed. The picture dies every evening. I might have been charged twice last month — maybe I want a pause, maybe the money back, maybe I am just mad.',
      plan: 'standard',
      previousTickets: 1,
    },
    questions: SUPPORT_QUESTIONS,
  ...
  },
  {
    ...
    blurb: 'Plant mail about returns — queue and severity without naming a customer.',
    surface: 'email',
    editHint: 'Edit the subject or body, then run again.',
    state: {
      from: 'ops@customerco.example',
      subject: 'Last week’s shipment came back',
      body:
        'Last week’s shipment is back on the dock. The cartons were open and several parts do not match the packing list. We need a queue and a severity before the next shift.',
    },
    questions: {
      queue: {
        type: 'choice',
  ...
  },
  {
    ...
    blurb: 'Same honesty as the LLM weather demo — when is the tool the right move?',
    surface: 'ask',
